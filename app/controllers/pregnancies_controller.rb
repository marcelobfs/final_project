class PregnanciesController < ApplicationController
  ...
  def create_row_from_cattle_catalog
    ...
    if @pregnancy.valid?
      ...
      redirect_to("/cattle_catalogs/#{@pregnancy.cattle_id}", notice: "Pregnancy created successfully.")
    else
      render("pregnancy_templates/new_form_with_errors.html.erb")
    end
  end
  ...
  def destroy_row_from_cattle
    ...
    redirect_to("/cattle_catalogs/#{@pregnancy.cattle_id}", notice: "Pregnancy deleted successfully.")
  end
